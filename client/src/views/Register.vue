<template>
    ...
    <div class="register">
        ...
        <form class="ui form" @submit.prevent="register">
            ...
            <div class="field">
                <input type="text" placeholder="Corre electronico" v-model="formData.email" :class ="{error: formError.email}" />
            </div>
            <div class="field">
                <input type="text" placeholder="Contraseña" v-model="formData.password"  :class ="{error: formError.password }"/>
            </div>
